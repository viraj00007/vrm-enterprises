        ...
        <section className="px-6 md:px-12 py-24" style={{ background: '#ffffff' }}>
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-display font-black leading-tight mb-4 reveal" style={{ fontSize: 'clamp(32px, 4vw, 52px)', color: '#0f172a' }}>
                        What Doctors <span style={{ color: '#2563eb' }}>Say</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {TESTIMONIALS.map((t, i) => (
                        ...
                        >
                            <div className="font-display font-black text-6xl leading-none mb-2" style={{ color: `${t.color}20` }}>"</div>
                            <StarRating count={t.rating} />
                            <p className="text-sm leading-relaxed mb-6" style={{ color: '#475569' }}>
                                "{t.text}"
                            </p>
                            <div className="flex items-center gap-3" style={{ borderTop: '1px solid rgba(37,99,235,0.08)', paddingTop: 16 }}>
                                <div
                                ...
                                <div>
                                    ...
                                    <div className="text-xs" style={{ color: '#94a3b8' }}>{t.hospital}</div>
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                >
                    {[
                        { num: '50+', label: 'Hospitals Served', color: '#2563eb' },
                        { num: '10,000+', label: 'Orders Delivered', color: '#059669' },
                        { num: '100%', label: 'Quality Assured', color: '#d97706' },
                    ].map((s, i) => (
                        <div key={i} className="text-center">
                            <div className="font-display font-black text-3xl md:text-4xl" style={{ color: s.color }}>{s.num}</div>
                            <div className="text-xs mt-1 font-medium uppercase tracking-wider" style={{ color: '#64748b' }}>{s.label}</div>
                        </div>
                    ))}
                </div>
            </div>
