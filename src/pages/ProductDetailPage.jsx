  ...
  return (
    <div className="relative flex items-end justify-center gap-6" style={{ height: 320 }}>
      <div
        ...
        style={{ background: `radial-gradient(circle at 50% 70%, ${color}15 0%, transparent 65%)` }}
      />
      {/* Main vial */}
      <div className="relative flex flex-col" style={{ width: 100, height: 280 }}>
        ...
        <div className="flex-1 relative overflow-hidden rounded-b-xl" style={{
          background: 'linear-gradient(160deg,rgba(255,255,255,0.97) 0%,rgba(241,245,249,0.93) 100%)',
          border: `1px solid ${color}30`,
          boxShadow: `0 24px 64px rgba(8,145,178,0.15), inset 0 1px 0 rgba(255,255,255,0.9), 0 0 40px ${color}12`,
        }}>
      ...
      <div className="relative flex flex-col self-end" style={{ width: 65, height: 185 }}>
        ...
        <div className="flex-1 relative overflow-hidden rounded-b-lg" style={{
          ...
          boxShadow: `0 15px 40px rgba(8,145,178,0.08)`,
        }}>
...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    if (product) document.title = `VRM Enterprises | ${product.name}`
    return () => { document.title = 'VRM Enterprises' }
  }, [product])

  if (!product) return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#f8faff', paddingTop: 72 }}>
  ...
  return (
    <div className="min-h-screen" style={{ background: '#f8faff', paddingTop: 72 }}>
      ...
      {/* Dark header banner */}
      <div
        className="px-6 md:px-12 py-8 relative overflow-hidden"
      ...
      >
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-sm font-medium transition-all hover:-translate-x-1 relative z-10 mb-4"
        ...
        <div className="relative z-10">
          <span
            className="inline-block text-xs font-black tracking-widest uppercase px-3 py-1.5 rounded-full mb-3"
          ...
          <p className="text-sm mt-2 font-semibold" style={{ color }}>{product.composition}</p>
        </div>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto px-6 md:px-12 py-10">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          {/* LEFT — Vial illustration */}
          <div>
            <div
              className="relative rounded-3xl p-10 flex items-center justify-center"
              style={{
                background: `radial-gradient(ellipse at center, ${color}10 0%, rgba(239,246,255,0.8) 70%)`,
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: '0 2px 8px rgba(8,145,178,0.05)',
                  }}
                >
          ...
          <div>
            ...
            <div style={{ borderTop: '1px solid rgba(8,145,178,0.1)', marginBottom: 24 }} />
            ...
            >
              <div className="text-sm" style={{ color: '#64748b' }}>
                Interested in this product? Send us an enquiry and our team will contact you with
                pricing and availability within 24 hours.
              </div>
              <button
                onClick={() => navigate('/enquiry', { state: { selectedProduct: product.name } })}
                className="btn-gradient w-full py-4 rounded-xl font-bold text-base text-white"
                style={{ boxShadow: `0 8px 30px rgba(8,145,178,0.3)` }}
              >
